...
VALUES
    ...
    ('blueprint', $json$
    {
      ...
      "fields": [
        ...
        {"type":"json","name":"actionKeys","label":"动作键"},
        {"type":"json","name":"confirmationGates","label":"确认门"},
    ...
    ('execution-run', $json$
    {
      ...
      "fields": [
        ...
        {"type":"number","name":"parentRunId","label":"父执行 ID","readOnly":true},
    ...
    ('work', $json$
    {
      ...
      "fields": [
        ...
        {"type":"number","name":"adoptedObjectVersionId","label":"采用对象版本 ID","readOnly":true},
