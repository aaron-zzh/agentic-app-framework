...
'[
  ...
  {"id":"personal-shortcuts","type":"shortcut","title":"快捷入口","position":{"x":0,"y":2,"w":12,"h":2},"config":{"type":"shortcut","items":[{"label":"AI 创作","href":"/studio/create","icon":"sparkles"},{"label":"项目","href":"/studio/projects","icon":"folder-kanban"},{"label":"素材库","href":"/studio/assets/materials","icon":"image"},{"label":"知识库","href":"/studio/knowledge","icon":"database"}]}},
