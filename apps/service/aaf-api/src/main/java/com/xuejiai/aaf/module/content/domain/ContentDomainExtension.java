...
@Setter
@Entity
@Table(name = "cs_domain_extension")
@SQLDelete(
        sql =
                "UPDATE cs_domain_extension SET deleted = true, delete_time = CURRENT_TIMESTAMP WHERE id = ?")
public class ContentDomainExtension extends BaseEntity {
