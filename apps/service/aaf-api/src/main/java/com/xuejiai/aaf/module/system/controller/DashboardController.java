...
import com.xuejiai.aaf.module.system.service.DashboardService;
...
public class DashboardController {
    ...
    @PutMapping("/{id}")
    public Result<DashboardVO> update(@PathVariable Long id, @Validated @RequestBody DashboardUpdateDTO dto) {
