 ...
 * 会议记录整理接口。
 *
 * <p>积分预检与结算由 {@link com.xuejiai.aaf.framework.engine.credit.AiCreditAspect} 切面 +
 * {@link com.xuejiai.aaf.framework.intelligent.ai.chat.ResilientChatService} 内部统一处理，无需手动扣减。
 */
...
public class MeetingOrganizeController {
    ...
    @Operation(summary = "整理会议记录", description = "将 ASR 转写文本整理为结构化会议记录（Markdown），包含议题、决策、待办列表，并补充日期")
