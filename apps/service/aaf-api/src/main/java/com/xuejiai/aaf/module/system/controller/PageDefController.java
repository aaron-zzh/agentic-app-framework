...
import com.xuejiai.aaf.module.system.service.PageDefService;
...
public class PageDefController {
    ...
    @PutMapping("/{id}")
    public Result<PageDefVO> update(@PathVariable Long id, @Validated @RequestBody PageDefCreateDTO dto) {
