...
import com.xuejiai.aaf.module.system.domain.UserOauth;
import com.xuejiai.aaf.module.system.repository.UserOauthRepository;
import com.xuejiai.aaf.module.system.repository.UserRepository;
import com.xuejiai.aaf.module.system.vo.*;
...
public class AuthService {
    ...
    public AuthLoginVO oauthLogin(String provider, String code, String deviceId) {
        ...
        // 查找是否已绑定
        var oauthOpt = userOauthRepository.findByProviderAndProviderUserId(
    ...
    public void bindOAuth(Long userId, String provider, String code) {
        ...
        // 检查是否已被其他用户绑定
        var existing = userOauthRepository.findByProviderAndProviderUserId(
                userInfo.provider(), userInfo.providerUserId());
    ...
    private void sendVerifyCode(String email, String type) {
        ...
        redisTemplate.opsForValue().set(codeKey, code, Duration.ofMinutes(5));
        log.info("【验证码】邮箱={}, 类型={}, 验证码={}", email, type, code);
    }
