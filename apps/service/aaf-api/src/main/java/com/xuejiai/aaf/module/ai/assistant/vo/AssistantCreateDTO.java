...
public record AssistantCreateDTO(
        ...
        @Schema(description = "所属用户 ID", requiredMode = Schema.RequiredMode.REQUIRED) @NotNull
                Long userId,
        @Schema(description = "关联的 Actor ID", requiredMode = Schema.RequiredMode.REQUIRED) @NotBlank
                String actorId,
        @Schema(description = "关联的 Role ID", requiredMode = Schema.RequiredMode.REQUIRED) @NotBlank
                String roleId,
