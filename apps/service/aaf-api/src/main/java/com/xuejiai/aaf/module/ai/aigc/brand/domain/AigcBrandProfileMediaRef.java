...
@Setter
@Entity
@Table(name = "aigc_brand_profile_media_ref")
@SQLDelete(
        sql =
                "UPDATE aigc_brand_profile_media_ref SET deleted = true, delete_time = CURRENT_TIMESTAMP WHERE id = ?")
public class AigcBrandProfileMediaRef {
