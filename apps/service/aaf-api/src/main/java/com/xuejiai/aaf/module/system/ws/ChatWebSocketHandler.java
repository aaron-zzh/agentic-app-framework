...
public class ChatWebSocketHandler extends TextWebSocketHandler {
    ...
    private final ConcurrentHashMap<Long, ConcurrentHashMap<Long, WebSocketSession>> sessionConnections =
    ...
    public void afterConnectionEstablished(WebSocketSession session) {
        ...
        sessionConnections.computeIfAbsent(sessionId, k -> new ConcurrentHashMap<>()).put(userId, session);
