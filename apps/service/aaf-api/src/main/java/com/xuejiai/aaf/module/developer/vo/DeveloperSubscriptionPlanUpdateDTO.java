...
/** 更新开发者订阅套餐请求。 */
public record DeveloperSubscriptionPlanUpdateDTO(
        @Size(max = 100) @Schema(description = "套餐名称") String name,
        @Min(0) @Schema(description = "有效天数，0 表示永久") Integer durationDays,
        @Min(0) @Schema(description = "价格，单位：分") Long price,
        @Min(0) @Schema(description = "套餐包含 Token 数") Long includedTokens,
