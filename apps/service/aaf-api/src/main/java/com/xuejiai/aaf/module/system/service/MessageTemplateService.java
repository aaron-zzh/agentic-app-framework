...
import com.xuejiai.aaf.module.system.domain.MessageTemplate;
import com.xuejiai.aaf.module.system.repository.MessageTemplateRepository;
...
public class MessageTemplateService implements MessageTemplateProvider {
    ...
    public Optional<MessageTemplateInfo> findByCode(String code) {
        return repository.findByCodeAndDeletedFalse(code).map(t -> new MessageTemplateInfo(
                t.getCode(), MessageChannel.valueOf(t.getChannel()), t.getSubject(), t.getContent()));
    }
