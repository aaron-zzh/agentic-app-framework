...
import com.xuejiai.aaf.module.system.service.NotificationService;
...
public class NotificationController {
    ...
    @GetMapping
    public Result<PageResult<NotificationVO>> page(@Validated @ParameterObject NotificationPageDTO request) {
