...
public class AutomationController {
    ...
    @PutMapping("/rules/{id}")
    public Result<Void> updateRule(@PathVariable Long id, @Validated @RequestBody AutomationRuleCreateDTO dto) {
    ...
    @GetMapping("/logs")
    public Result<PageResult<AutomationLogVO>> pageLogs(@Validated @ParameterObject AutomationLogPageDTO req) {
