 ...
 *
 * <p>权限模型不设独立角色层级：工作区创建者拥有全部管理权限（邀请/移除成员、改名、删除工作区）， 由 {@link WorkspaceService} 内部按 {@code createBy}
 * 校验，不使用 {@code @PreAuthorize} 角色声明。
 *
...
public class WorkspaceController
    ...
    @Operation(summary = "邀请成员加入工作区", description = "仅工作区管理者（创建者）可操作")
    ...
    @Operation(summary = "移除工作区成员", description = "仅工作区管理者（创建者）可操作，管理者本人不可被移除")
