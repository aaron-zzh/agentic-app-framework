...
import com.xuejiai.aaf.module.system.domain.Subscription;
import com.xuejiai.aaf.module.system.repository.SubscriptionRepository;
...
public class SubscriptionService {
    ...
    /** 创建订阅 */
    @Transactional
    public Subscription create(Long userId, String entityType, Long entityId, String fields, String channels) {
    ...
    public void cancel(Long userId, Long id) {
        var sub = subscriptionRepository.findById(id)
                .orElseThrow(() -> new BusinessException(GlobalErrorCode.NOT_FOUND, "订阅不存在"));
