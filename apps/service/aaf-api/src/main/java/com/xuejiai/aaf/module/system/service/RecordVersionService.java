...
import com.xuejiai.aaf.module.system.repository.RecordVersionRepository;
...
public class RecordVersionService {
    ...
    public RecordVersion createSnapshot(String entityType, Long entityId, String data) {
        // 获取当前最大版本号
        int nextVersion = recordVersionRepository
        ...
        if (count > maxPerRecord) {
            var all = recordVersionRepository.findByEntityTypeAndEntityIdOrderByVersionDesc(entityType, entityId);
    ...
    public List<RecordVersion> listVersions(String entityType, Long entityId) {
        return recordVersionRepository.findByEntityTypeAndEntityIdOrderByVersionDesc(entityType, entityId);
    }
