...
public class CalendarTools {
    ...
    public String createCalendarEvent(
            ...
            @ToolParam(name = "start_time", description = "开始时间，格式 yyyy-MM-dd HH:mm") String startTime,
        ...
        try {
            ...
            return String.format("✅ 日程已创建：%s，时间：%s ~ %s",
                    title, start.format(FMT), end.format(FMT));
        } catch (Exception e) {
