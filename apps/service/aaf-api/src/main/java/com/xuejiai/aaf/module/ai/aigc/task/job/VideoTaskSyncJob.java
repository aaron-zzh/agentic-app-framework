...
import com.xuejiai.aaf.framework.intelligent.ai.video.VideoGenerationService.VideoTaskResult.TaskStatus;
            ...
            try {
                ...
                if (result.status() == TaskStatus.SUCCEEDED) {
                    log.info(
                            ...
                            task.getId(),
                            result.videoUrl());
                    aigcTaskService.completeTask(thirdTaskId, result.videoUrl());
                    ...
                    log.warn(
                            ...
                            task.getId(),
                            result.status());
                    aigcTaskService.failTask(thirdTaskId, "视频生成失败: " + result.status());
                }
