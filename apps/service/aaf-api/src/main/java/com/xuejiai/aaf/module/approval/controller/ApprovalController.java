...
import com.xuejiai.aaf.module.approval.service.ApprovalOperationService;
import com.xuejiai.aaf.module.approval.service.ApprovalPermissionService;
...
import com.xuejiai.aaf.module.approval.service.CountersignService;
...
public class ApprovalController {
    ...
    public Result<Void> addSignBefore(@Validated @RequestBody AddSignDTO dto) {
        ...
        var task = approvalProcessService.requireTaskOperator(dto.taskId(), userId);
    ...
    public Result<Void> withdraw(@Validated @RequestBody WithdrawDTO dto) {
        var userId = currentUserId();
        approvalProcessService.requireInstanceAccess(dto.processInstanceId(), userId);
    ...
    public Result<List<ApprovalRecordService.ApprovalRecordVO>> getTimeline(
        ...
        approvalProcessService.requireInstanceAccess(processInstanceId, currentUserId());
