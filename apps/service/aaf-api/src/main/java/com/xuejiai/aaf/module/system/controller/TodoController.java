...
import com.xuejiai.aaf.module.system.service.TodoService;
import com.xuejiai.aaf.module.system.vo.TodoPageDTO;
import com.xuejiai.aaf.module.system.vo.TodoStatusDTO;
...
public class TodoController {
    ...
    public Result<Void> updateStatus(@PathVariable Long id, @Validated @RequestBody TodoStatusDTO dto) {
        Long userId = actorContext.currentUserId().orElseThrow();
