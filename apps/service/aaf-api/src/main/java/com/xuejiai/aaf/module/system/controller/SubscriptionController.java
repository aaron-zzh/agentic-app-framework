...
public class SubscriptionController {
    ...
    public Result<Subscription> create(@RequestBody CreateRequest request) {
        ...
        var sub = subscriptionService.create(
                userId, request.entityType(), request.entityId(), request.fields(), request.channels());
    ...
    public Result<List<Subscription>> list(
        ...
        Long userId = actorContext.currentUserId().orElseThrow();
        return Result.success(subscriptionService.listByUserAndEntity(userId, entityType, entityId));
    }
