...
public final class AigcAssetResource {
    public static final ResourceKey KEY = ResourceKey.of("aigc.asset");
    public static final String BASE_PATH = "/api/aigc/assets";

    private static final CrudResourceTypeContract<AigcAsset> TYPES =
            CrudResourceTypeContract.fromCrudController(AigcAssetController.class, AigcAsset.class);

    public static final CrudResourceDefinition<AigcAsset> DEFINITION =
