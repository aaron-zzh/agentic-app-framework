...
import com.xuejiai.aaf.module.system.repository.NotificationPreferenceRepository;
...
public class NotificationPreferenceService {
    ...
    /** 更新偏好（upsert） */
    @Transactional
    public NotificationPreference upsert(Long userId, String preferences, LocalTime quietStart, LocalTime quietEnd) {
        var pref = repository.findByUserId(userId).orElseGet(() -> {
