...
public record TokenUsageEvent(
        Long userId, Long modelId, long promptTokens, long completionTokens, String usageId) {

    public TokenUsageEvent(Long userId, Long modelId, long promptTokens, long completionTokens) {
        this(userId, modelId, promptTokens, completionTokens, UUID.randomUUID().toString());
    }
