 ...
 */
package com.xuejiai.aaf.framework.agentscope.session.tool;
...
import com.xuejiai.aaf.framework.agentscope.session.CommandLane;
import com.xuejiai.aaf.framework.agentscope.session.HistoryResult;
import com.xuejiai.aaf.framework.agentscope.session.PendingCompletion;
import com.xuejiai.aaf.framework.agentscope.session.SendResult;
 ...
 * a {@code task_id} for retrieval via the companion {@link TaskTool}. The same completion may also
 * be queued for the requester as a structured {@link PendingCompletion} (poll with {@code
