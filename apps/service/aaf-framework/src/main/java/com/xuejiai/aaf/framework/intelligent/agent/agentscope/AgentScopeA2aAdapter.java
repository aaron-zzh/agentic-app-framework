 ...
 *
 * <p>适配策略：委托给 AgentScope 官方 A2A 扩展
 * ({@code agentscope-extensions-a2a} + {@code agentscope-a2a-spring-boot-starter})，
 * 替换 AAF 自研的 {@code A2AProtocolService}（当前仅占位）。
 *
 * <p>AgentScope A2A 扩展提供：
 * <ul>
 *   <li>标准 A2A 协议（Task / Artifact / Message 三种对象）</li>
 *   <li>多种服务发现后端：Well-Known / Nacos / File</li>
 *   <li>RocketMQ 异步传输（{@code agentscope-extensions-rocketmq}）</li>
 *   <li>Spring Boot Starter 自动配置 A2A Server/Client</li>
 * </ul>
 *
 * <p>TODO: 引入 agentscope-a2a-spring-boot-starter 后，
 * 注入 AgentScope A2A Client/Server Bean，
 * 删除 AAF 自研 A2AProtocolService，补全此处委托逻辑。
 */
@Slf4j
