...
public interface AutomationAuditRepository extends JpaRepository<AutomationAuditEntity, String> {
    List<AutomationAuditEntity> findByTenantIdAndAutomationIdAndOccurredAtBetweenOrderByOccurredAtDesc(String tenantId, String automationId, Instant from, Instant to);
}
