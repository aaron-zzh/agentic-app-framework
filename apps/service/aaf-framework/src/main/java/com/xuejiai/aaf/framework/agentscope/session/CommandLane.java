 ...
 * semantics.
 *
 * <p>AgentStateStore serialization (one embedded run at a time per {@code sessionKey}) is
 * implemented separately via per-session locks; lanes bound <strong>global</strong> concurrency
 * across sessions (e.g. cap parallel subagent runs process-wide).
 */
