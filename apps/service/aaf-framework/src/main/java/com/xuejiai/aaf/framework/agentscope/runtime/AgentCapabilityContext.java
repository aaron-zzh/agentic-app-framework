 ...
 *
 * <p>在 AG-UI 请求线程（executor.submit 内）按 resolvedAgentId 写入， 由 {@link
 * com.xuejiai.aaf.framework.agentscope.middleware.CallLogMiddleware} 读取， 用于 {@code
 * credit_transaction.category} 字段，区分文案生成与普通对话。
 */
