 ...
 */
package com.xuejiai.aaf.framework.agentscope.observability;
 ...
 *
 * <p>Metrics are exposed via Spring Boot Actuator ({@code /actuator/prometheus}) and can be scraped
 * by Prometheus or shipped to an OTel collector via the Micrometer OTel bridge.
 *
 * <p>Key metrics:
 *
 * <ul>
