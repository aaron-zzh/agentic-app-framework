 ...
 * <p>支持模型：
 * <ul>
 *   <li>happyhorse-1.0-t2v — 文生视频</li>
 *   <li>happyhorse-1.0-i2v — 图生视频（首帧）</li>
 *   <li>happyhorse-1.0-video-edit — 视频编辑</li>
 * </ul>
 */
@Slf4j
@Service
...
public class DashScopeVideoGenerationService implements VideoGenerationService {
    ...
    private static final String SUBMIT_URL = "https://dashscope.aliyuncs.com/api/v1/services/aigc/video-generation/video-synthesis";
    ...
    public VideoTaskResult query(String taskId) {
        try {
            ...
            return new VideoTaskResult(taskId, status, videoUrl, origPrompt, submitTime, endTime, duration);
        } catch (Exception e) {
            log.error("[HappyHorse] 查询任务失败: taskId={}", taskId, e);
            return new VideoTaskResult(taskId, VideoTaskResult.TaskStatus.UNKNOWN, null, null, null, null, null);
        }
    }

    // === 内部方法 ===

    private String doSubmit(String model, Map<String, Object> input, Map<String, Object> parameters) {
        try {
