...
export const AAF_AI_TASK_EVENT_TYPES = [
  ...
  "aaf.run.completed",
  "aaf.run.failed",
  "aaf.executor_plan.created",
  "aaf.executor_plan.submitted",
  "aaf.executor_plan.execution_started",
  "aaf.executor_plan.completed",
  "aaf.executor_plan.failed",
  "aaf.executor_plan.cancelled",
  "aaf.executor_plan.step_started",
  "aaf.executor_plan.step_completed",
  "aaf.executor_plan.step_failed",
  "aaf.message.started",
