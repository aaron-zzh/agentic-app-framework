...
export const restEndpoints = {
  ...
  dashboard: {
    ...
    defaultDashboard: "/dashboards/default",
    dashboardLayout: (id: string) => `/dashboards/${id}/layout`,
    widgetData: (widgetId: string) => `/dashboards/widgets/${widgetId}/data`,
  ...
  workflow: {
    ...
    workflowStatus: (processInstanceId: string) => `/workflow/${processInstanceId}`,
    workflowHistory: (processInstanceId: string) => `/workflow/${processInstanceId}/history`,
