...
import type { MixinDef } from "./mixins"
import { builtinMixins } from "./mixins"
import { resolveExtends, resolveMixins } from "./resolve"
 ...
 * 用法：
 * ```ts
 * import { entityRegistry, documentEntity, taskEntity } from "@/features/entity-engine"
 *
 * // 注册实体
