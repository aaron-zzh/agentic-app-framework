/**
 * ExpensesCategoryWidget——支出分类极坐标饼图 + 分类列表
 */
...
export function ExpensesCategoryWidget({ title, series }: ExpensesCategoryWidgetProps) {
  ...
  const total = series.reduce((s, i) => s + i.value, 0)
      ...
      <CardContent>
        ...
        <div className="grid grid-cols-2 text-center">
          <div className="py-2">
            ...
            <p className="font-bold text-xl">{series.length}</p>
          </div>
