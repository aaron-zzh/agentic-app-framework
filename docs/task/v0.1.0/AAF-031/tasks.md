...
4. [ ] #4 WebSocket 实时推送 — developer-api + developer-web (依赖: #2)
...
5. [ ] #5 通知偏好设置 — developer-web + developer-api (依赖: #3)
...
6. [ ] #6 乐观锁冲突处理 — developer-web + developer-api (依赖: AAF-029 #2)
...
8. [ ] #8 richText CRDT 协同 — developer-web (依赖: #7)
   - Yjs + Tiptap 集成
...
10. [ ] #10 版本历史 UI + Diff View — developer-web (依赖: #9)
...
12. [ ] #12 活动流前端（Chatter） — developer-web (依赖: #11)
...
13. [ ] #13 字段变更订阅 — developer-web + developer-api (依赖: #4, #11)
    - 表单 [👁 关注] 按钮 → 订阅配置弹窗
...
14. [ ] #14 @提及待办联动 — developer-web + developer-api (依赖: #12, #2)
