...
1. [ ] #1 Toast 通知系统 — developer-webui
   - 集成 sonner 库
...
3. [ ] #3 消息中心前端 — developer-webui (依赖: #2)
   - AppHeader 🔔 图标 + 未读红点
...
4. [ ] #4 WebSocket 实时推送 — developer-service + developer-webui (依赖: #2)
...
5. [ ] #5 通知偏好设置 — developer-webui + developer-service (依赖: #3)
...
6. [ ] #6 乐观锁冲突处理 — developer-webui + developer-service (依赖: AAF-029 #2)
...
7. [ ] #7 多人在线感知 — developer-webui (依赖: #4)
...
8. [ ] #8 richText CRDT 协同 — developer-webui (依赖: #7)
   - Yjs + Tiptap 集成
...
10. [ ] #10 版本历史 UI + Diff View — developer-webui (依赖: #9)
...
12. [ ] #12 活动流前端（Chatter） — developer-webui (依赖: #11)
...
13. [ ] #13 字段变更订阅 — developer-webui + developer-service (依赖: #4, #11)
    - 表单 [👁 关注] 按钮 → 订阅配置弹窗
...
14. [ ] #14 @提及待办联动 — developer-webui + developer-service (依赖: #12, #2)
...
15. [ ] #15 PWA 基础支持 — developer-webui
