...
> 负责人：architect + developer-service + developer-webui + developer-uniapp | 创建：05-05
...
1. ✅ #17 Maven 多模块拆分 + 完整包目录 — architect + developer-service
...
2. ✅ #26 根 pom 清理与 Preview 特性启用 — developer-service (依赖: #17)
...
3. ✅ #27 aaf-dependencies BOM 完善 — developer-service (依赖: #17)
...
4. ✅ #28 aaf-common 依赖轻量化 — developer-service (依赖: #27)
...
10. ✅ #31 用户管理 CRUD 接口 — developer-service (依赖: #20, #30)
...
11. ✅ #24 CI 基础设施（GitHub Actions） — developer-service (依赖: #20)
...
11. ✅ #29 包结构约定与 ArchUnit 规则扩展 — developer-service + architect (依赖: #21, #30)
...
12. ✅ #18 前端参考调研 + 完整目录结构 — architect + developer-webui
