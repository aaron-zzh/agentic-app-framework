...
1. [x] #3601 接入 Nx monorepo — developer-app
...
2. [x] #3602 补充缺失依赖 — developer-app (依赖: #3601)
...
5. [x] #3605 SSE 双端流式通信 — developer-app (依赖: #3602)
...
9. [x] #3609 用户状态与认证 — developer-app (依赖: #3608)
   - 创建 `src/store/user.ts`：token、用户信息、角色（user/admin）、权限列表、登录/登出
   - 持久化到 `uni.storage`
   - verify: 登录后重启小程序，用户状态保持

10. [x] #3610 alova 请求实例配置 — developer-app (依赖: #3609)
...
11. [x] #3611 用户端页面骨架 — developer-app (依赖: #3609)
...
12. [x] #3612 管理端分包骨架 — developer-app (依赖: #3608)
...
13. [x] #3613 AI Skills 迁移 — developer-app (依赖: #3601)
...
14. [x] #3614 脚手架 Demo 清理 — developer-app (依赖: #3611, #3612)
...
15. [x] #3615 启动页与登录流程 — developer-app (依赖: #3609)
...
16. [x] #3616 文件上传 composable — developer-app (依赖: #3610)
...
17. [x] #3617 AI 对话消息列表（虚拟列表） — developer-app (依赖: #3611)
...
18. [x] #3618 Markdown 渲染 — developer-app (依赖: #3617)
...
19. [x] #3619 Canvas 海报生成与编辑 — developer-app (依赖: #3602)
...
20. [x] #3620 消息通知页 — developer-app (依赖: #3611)
...
21. [x] #3621 用户信息与设置 — developer-app (依赖: #3616)
...
22. [x] #3622 管理端扩展页面 — developer-app (依赖: #3612)
...
23. [x] #3623 多模态图像处理 — developer-app (依赖: #3616, #3617)
...
24. [x] #3624 Echarts 图表封装 — developer-app (依赖: #3612)
...
25. [x] #3625 对话内嵌交互组件（widget）— developer-app (依赖: #3617)
...
26. [x] #3626 对话内联路由跳转 — developer-app (依赖: #3617)
