...
1. ✅ #32 EntityDef 类型定义 — developer-webui
...
2. ✅ #33 Mixin 与继承机制 — developer-webui (依赖: #32)
...
3. ✅ #34 实体注册表（Entity Registry） — developer-webui (依赖: #33)
...
4. ✅ #35 组件注册表（Component Registry） — developer-webui (依赖: #32)
...
5. ✅ #36 ViewEngine 核心渲染器 — developer-webui (依赖: #34, #35)
...
6. ✅ #37 动态路由搭建 — developer-webui (依赖: #36)
...
7. ✅ #38 ListView 基础实现 — developer-webui (依赖: #36)
...
8. ✅ #39 KanbanView 基础实现 — developer-webui (依赖: #36)
   - 基于 @dnd-kit 实现看板视图
...
9. ✅ #40 FormView 基础实现 — developer-webui (依赖: #36)
...
10. ✅ #41 工作区布局壳 — developer-webui (依赖: #37)
...
11. ✅ #42 视图切换与 Toolbar — developer-webui (依赖: #41, #38)
...
12. ✅ #43 分层错误边界 — developer-webui (依赖: #36, #40)
...
13. ✅ #44 基础字段组件集 — developer-webui (依赖: #35)
...
14. ✅ #45 加载状态与骨架屏 — developer-webui (依赖: #38, #40)
    - 列表骨架屏：匹配列数/行数
    - 表单骨架屏：匹配字段数
    - 路由切换顶部进度条
...
15. ✅ #46 targetDefaults 统一配置 — developer-webui (依赖: #32)
...
16. ✅ #47 Playwright E2E 测试栈 — developer-webui (依赖: #37)
    - 来源：AAF-023 #22，前置页面就绪后引入
    - Vitest 单测已就绪，本任务补充 Playwright E2E
    - verify: `pnpm nx run webui-e2e:e2e` 跑通

17. ✅ #48 UniApp 参考调研 + 完整目录结构 — architect + developer-uniapp
    - 来源：AAF-023 #19
    - 参考 kids-app 项目结构
