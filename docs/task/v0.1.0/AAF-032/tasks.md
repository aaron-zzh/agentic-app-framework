...
> 负责人：architect + developer-service + developer-webui | 创建：05-13
...
1. ✅ #1 RBAC 权限后端 — developer-service
...
2. ✅ #2 权限驱动 UI — developer-webui (依赖: #1)
...
3. ✅ #3 行级数据权限 — developer-service (依赖: #1)
...
4. ✅ #4 行级权限管理 UI — developer-webui (依赖: #3)
...
5. ✅ #5 软删除与回收站后端 — developer-service
...
6. ✅ #6 回收站前端 — developer-webui (依赖: #5)
   - 侧边栏底部 [🗑️ 回收站] 入口
...
7. ✅ #7 数据归档 — developer-service + developer-webui (依赖: #5)
...
8. ✅ #8 Flowable 集成 — developer-service
...
9. ✅ #9 审批工作流前端 — developer-webui (依赖: #8)
...
10. ✅ #10 审批委托 — developer-service + developer-webui (依赖: #8)
...
11. ✅ #11 自动化规则后端 — developer-service
...
12. ✅ #12 自动化规则前端 — developer-webui (依赖: #11)
...
13. ✅ #13 审计日志后端 — developer-service
...
14. ✅ #14 审计日志前端 — developer-webui (依赖: #13)
...
15. ✅ #15 计划任务管理 — developer-service + developer-webui (依赖: #11)
