...
详见 [工作流引擎](../execution/workflow.md)。
...
遵循五层智能架构，详见 [智能体系统设计](../../intelligent/architecture.md)。
...
详见 [知识库引擎](../data-knowledge/nexus-knowledge.md) | [记忆引擎](../data-knowledge/atom-memory.md)。
...
代码结构见 [元引擎设计](meta-engine.md)。

## 相关文档

- [元引擎设计](meta-engine.md)
- [执行调度器](execution-dispatcher.md)（调度运行时能力的入口）
- [工作流引擎](../execution/workflow.md)
- [智能体系统设计](../../intelligent/architecture.md)
