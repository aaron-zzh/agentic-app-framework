...
> 各组件详细设计见：[Cognition](intelligent/cognition.md) · [AtomMemory](engine/atom-memory.md) · [NexusKB](engine/nexus-knowledge.md) · [状态管理器](core/state-manager.md)
...
| 文档 | 内容 |
|------|------|
| [cognition.md](intelligent/cognition.md) | Cognition 层详细设计（记忆分区/检索管道/价值观） |
| [atom-memory.md](engine/atom-memory.md) | AtomMemory 引擎（原子化存储/双时态索引/遗忘策略） |
| [nexus-knowledge.md](engine/nexus-knowledge.md) | NexusKB 知识引擎（向量检索/知识图谱/RAG） |
| [state-manager.md](core/state-manager.md) | 状态管理器（四层状态/渐进提交/存储映射） |
| [agent.md](intelligent/agent.md) | Agent 工作记忆与注意力预算 |
| [architecture-detail.md](architecture-detail.md) | AgentScope 整合策略与适配层 |
